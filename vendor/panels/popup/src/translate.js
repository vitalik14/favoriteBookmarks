...
function translate() {
	...
	T.queryOne(".settings-btn").innerText = chrome.i18n.getMessage(
		"settings",
		null
	);
	T.queryOne(".xShowOnlyOneLine").innerText = chrome.i18n.getMessage(
		"xShowOnlyOneLine",
		null
	);
	...
	T.queryOne(".xBookmarks").innerText = chrome.i18n.getMessage(
		"xBookmarks",
		null
	);
